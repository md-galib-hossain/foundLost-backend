...
const createFoundItemCategory = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const token = req.headers.authorization;
    if (!token) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Authentication token not found !');
    }
    const result = yield itemcategory_service_1.foundItemCategoryService.createFoundItemCategoryIntoDB(req.body, token);
